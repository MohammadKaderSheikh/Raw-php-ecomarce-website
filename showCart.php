...
?>
<?php
// Function to get cart items from the database for a specific user
function getCartItems($user_id) {
    global $conn;

    // Prepare and execute the SQL query
    $stmt = $conn->prepare("SELECT p.product_id, p.name, p.image, p.price, c.cart_id, c.quantity
                           FROM cart c
...
// Calculate the total number of products in the cart for a specific user
...
// Calculate the total price of cart items for a specific user
...
// Fetch the user's cart items using $_SESSION['user_id']
